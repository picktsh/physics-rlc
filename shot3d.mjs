// capture 3D canvas region to png for visual review
...
const edge = spawn(EDGE, [
  ...
  '--user-data-dir=' + process.env.TEMP + '\\qoder-edge-tmp9',
  '--no-first-run',
...
writeFileSync('shot3d.png', Buffer.from(shot.result.data, 'base64'))
console.log('saved shot3d.png')
ws.close()
edge.kill()
process.exit(0)
