...
import { NButton, NInput, NDropdown, NSpace, NTag, NIcon } from 'naive-ui'
import { Add, Flash, Stop, SendAlt } from '@vicons/carbon'
    ...
    <div class="flex items-center justify-between gap-2">
      ...
      <NSpace align="center" :size="8">
        ...
        <NButton
          ...
          @click="handleSend"
        >
          <template #icon><NIcon :component="SendAlt" /></template>
        </NButton>
      </NSpace>
    </div>
  </form>
